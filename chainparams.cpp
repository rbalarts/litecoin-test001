...
{
    const char* pszTimestamp = "BBC World 14/Mar/2021 Bitcoin surges past $61,000 for first time.";
    const CScript genesisOutputScript = CScript() << ParseHex("060984710fa689ad5023690c80f3a49c8f13f8d45b8c857fbcbc8bc4a8e4d3eb4b10f4d4604fa08dce601aaf0f470216fe1b51850b4acf21b179c45070ac7b03a9") << OP_CHECKSIG;
...
public:
    CMainParams() {
        strNetworkID = "main";
        consensus.nSubsidyHalvingInterval = 79000;
        // consensus.BIP34Height = 710000;
        // consensus.BIP34Hash = uint256S("fa09d204a83a768ed5a7c8d441fa62f2043abf420cff1226c7b4329aeb9d51cf");
        // consensus.BIP65Height = 918684; // bab3041e8977e0dc3eeff63fe707b92bde1dd449d8efafb248c27c8264cc311a
        // consensus.BIP66Height = 811879; // 7aceee012833fa8952f8835d8b1b3ae233cd6ab08fdb27a771d2bd7bdc491894
        consensus.powLimit = uint256S("00000fffffffffffffffffffffffffffffffffffffffffffffffffffffffffff");
        consensus.nPowTargetTimespan = 3.5 * 24 * 60 * 60; // 6 days
        ...
        genesis = CreateGenesisBlock(1615734352, 2002666701, 0x1e0ffff0, 1, 24 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xa9e13ff7ac44b0a4c66c53741a6e07720cc5eb513cc31195cd02e2fab0eff9ee"));
        assert(genesis.hashMerkleRoot == uint256S("0xa1acb95ba803c49fbb3a6890745ed185ab32ab1002d55d7d07e7449c35e1e1ea"));

        // Note that of those with the service bits flag, most only support a subset of possible options
        vSeeds.push_back(CDNSSeedData("206.189.176.187", "206.189.176.187", true));
        // vSeeds.push_back(CDNSSeedData("thrasher.io", "dnsseed.thrasher.io", true));
        // vSeeds.push_back(CDNSSeedData("bitautools.com", "dnsseed.bitautools.com"));
        // vSeeds.push_back(CDNSSeedData("bitaupool.org", "dnsseed.bitaupool.org"));
        ...
        checkpointData = (CCheckpointData) {
            ...
            (  0, uint256S("0xa9e13ff7ac44b0a4c66c53741a6e07720cc5eb513cc31195cd02e2fab0eff9ee"))
        ...
        chainTxData = ChainTxData{
            ...
            1615734352, // * UNIX timestamp of last known number of transactions
            0,  // * total number of transactions between genesis and that timestamp //   (the tx=... number in the SetBestChain debug.log lines)
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1615734352, 443508, 0x1e0ffff0, 1, 24 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xe05c450af521e78772bfb16599de1c6b6fa2fd2f4bacfbbf7457519d86c10752"));
        assert(genesis.hashMerkleRoot == uint256S("0xa1acb95ba803c49fbb3a6890745ed185ab32ab1002d55d7d07e7449c35e1e1ea"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        vSeeds.push_back(CDNSSeedData("206.189.176.187", "206.189.176.187"));
        // vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-b.bitau.loshan.co.uk", true));
        ...
        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            ( 0, uint256S("0xe05c450af521e78772bfb16599de1c6b6fa2fd2f4bacfbbf7457519d86c10752")),
        };
...
public:
    CRegTestParams() {
        ...
        genesis = CreateGenesisBlock(1615734352, 0, 0x207fffff, 1, 24 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x2b8bfbc98a1c8f9883858872b69757e628d63f4c8942f2c7d1b8365e7a122de8"));
        assert(genesis.hashMerkleRoot == uint256S("0xa1acb95ba803c49fbb3a6890745ed185ab32ab1002d55d7d07e7449c35e1e1ea"));
        ...
        checkpointData = (CCheckpointData){
            boost::assign::map_list_of
            ( 0, uint256S("0x2b8bfbc98a1c8f9883858872b69757e628d63f4c8942f2c7d1b8365e7a122de8"))
        };
